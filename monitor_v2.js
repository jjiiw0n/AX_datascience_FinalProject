...
// --- Helpers & Parsers (Reused from parse.js) ---
...
async function monitor() {
    ...
    // For simplicity, we scrape common sites once.
    // If we have custom URLs later, we can scrape them individually.
    ...
    try {
        ...
        await page.goto('https://www.etri.re.kr/kor/bbs/list.etri?b_board_id=ETRI39', { waitUntil: 'networkidle' });
    ...
    try {
        const page = await context.newPage();
        await page.goto('https://www.btp.or.kr/index.php?pCode=MN2000192', { waitUntil: 'networkidle' });
    ...
    try {
        const page = await context.newPage();
        await page.goto('https://www.2030db.go.kr/user/youthIntern/selectYouthInternList.do', { waitUntil: 'networkidle' });
    ...
    for (const subscriber of subscribers) {
        ...
        for (const site of subscriber.monitoring_sites) {
            ...
            for (const post of posts) {
                ...
                const postKey = `${post.title.trim()}_${normalizedLink}`;
